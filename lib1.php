        ...
        <div class="BI">
            <div><br>
                ...
                <div class="contentBI panel panel-default home">
                    <h4 class="panel-heading text-center">CENTRAL LIBRARY FORM</h4>
                    <p>PAY DUES BEFORE RESUBMISSION OF FORM.</p>
                    <div class="panel-body">
                        <form action="lib1op.php" method="POST">
                    ...
                    <?php
                        echo "
                            <td><a href='lib1op.php?idnum=$row[idnum]' name='Submit' value='Submit'>Submit
                            </tr>";
                    ?>
