...
<html>
        ...
        <nav class="nav">
            <div class="row">
                ...
                <div class="col-xs-4 col-xs-offset-6">
                    ...
                    <div class="col-xs-2"><a href="acard">Admit Card</a></div>
                </div>
    ...
    <body>
        <div>
            <h1 class="ph">HOSTEL</h1>
            <table class='table-hover' id='hosteltable' name='hosteltable'>
                <thead>
                    <th>First Name</th>
                    <th>Last Name</th>
                    <th>ID Number</th>
                ...
                <tbody>
                    ...
                    <?php
                            echo "
                            <td><a href='accepthostel.php?idnum=$row[idnum]' name='accept'>Accept

                                <a href='declinehostel.php?idnum=$row[idnum]' name='decline'>Decline</td>
                            </tr>";
                        } 
                    ?>
                </tbody>
