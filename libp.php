<?php
    ...
    $sql = "SELECT * FROM centrallibrary";
        ...
        <div>
            ...
            <table class='table-hover'>
                ...
                <tbody>
                    ...
                    <?php
                            echo "
                            <td><a href='acceptlib.php?idnum=$row[idnum]' name='accept'>Accept
                                <a href='declinelib.php?idnum=$row[idnum]' name='decline'>Decline</td>
                            </tr>";
