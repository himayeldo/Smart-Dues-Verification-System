<?php
    ...
    $sql = "SELECT * FROM cooperativestore";
...
<html>
    ...
    <body>
        <div>
            <h1 class='ph'>COOPERATIVE STORE</h1>
            <table class='table-hover'>
                ...
                <tbody>
                    ...
                    <?php
                            echo "
                            <td><a href='acceptstore.php?idnum=$row[idnum]' name='accept'>Accept
                                <a href='declinestore.php?idnum=$row[idnum]' name='decline'>Decline</td>
                            </tr>";
